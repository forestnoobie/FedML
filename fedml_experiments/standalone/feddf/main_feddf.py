...
def load_data(args, dataset_name):
    ...
    if dataset_name == "mnist":
        ...
        class_num, *valid_idxs = data_loader(args.dataset, args.data_dir, args.partition_method,
                                args.partition_alpha, args.client_num_in_total, args.batch_size, args.valid_ratio)
...
def load_unlabeled_data(args, dataset_name):
    ...
    if dataset_name == "cifar10":
        train_data_num, test_data_num, train_dl, test_dl = get_unlabeled_dataloader_CIFAR10(args.data_dir,
                                                                                            args.unlabeled_batch_size,
                                                                                            args.unlabeled_batch_size)
    elif dataset_name == "cifar100":
        train_data_num, test_data_num, train_dl, test_dl = get_unlabeled_dataloader_CIFAR100(args.data_dir,
                                                                                            args.unlabeled_batch_size,
                                                                                            args.unlabeled_batch_size)
    else :
